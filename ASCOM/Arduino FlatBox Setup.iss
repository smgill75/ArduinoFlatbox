...
; Generated by Steven Gill on 3/8/2022 (UTC)
;
[Setup]
AppID={{d7811816-a470-437d-8118-651271c0609f}
AppName=ASCOM Arduino FlatBox CoverCalibrator Driver
AppVerName=ASCOM Arduino FlatBox CoverCalibrator Driver 6.5
AppVersion=6.5
AppPublisher=Steven Gill <smgill75@gmail.com>
AppPublisherURL=mailto:smgill75@gmail.com
...
OutputDir="."
OutputBaseFilename="Arduino FlatBox Setup"
Compression=lzma
...
[Dirs]
Name: "{cf}\ASCOM\Uninstall\CoverCalibrator\Arduino FlatBox"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoFlatbox.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoFlatbox.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ArduinoFlatbox.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ArduinoFlatbox.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ArduinoFlatbox.dll"""; Flags: runhidden 64bit; Check: IsWin64
